...
final class AdvancedSettingsViewController: NSViewController, SettingsPane {
	...
	override func viewDidLoad() {
        ...
        imageAIEnabledCheckbox.state = globalVar.imageAIEnabled ? .on : .off
    ...
    @IBAction func imageAIEnabledToggled(_ sender: NSButton) {
        let enabled = sender.state == .on
        globalVar.imageAIEnabled = enabled
        UserDefaults.standard.set(enabled, forKey: "imageAIEnabled")
        if enabled {
